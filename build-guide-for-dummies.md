...
We need to do the same thing for the **resize**(expanded) views of the creative. So that's also 3 modes (mobile, tablet, desktop). It's pretty straighforward, just make sure to populate the whole canvas to avoid any "blank" space once you preview the creative.
