...
Yep, every single design assets needs to be assembled using their platform. We don't get to control the HTML markup when using this format. At first, it's a bit "different" but once you get the hang of it, it's pretty ok :smile:
